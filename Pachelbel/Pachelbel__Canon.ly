...
\score {
  ...
  \with {instrumentName = #"Piccolo "}
  {
    ...
    fad'16 re'32 mi'32 fad'16 fad32^\markup{\bold\teeny (3)} sol32
    la32 si32 la32 sol32-2 la32^\markup{\bold\teeny (4)}
    fad32_\markup{\bold\teeny (1)} sol32 la32                            % 19
    ...
    si,16^\markup{\bold\teeny (2)}
    dod16^\markup{\bold\teeny (4)} la32 sol32-4 fad16 mi16               % 35
    re16 sol32 fad32 mi16 sol16  fad16 re32 mi32 fad16 la16
    sol16 si32 la32 sol16 fad16  mi16 la32 sol32 fad16 mi16              % 36
    \clef "tenor"
    fad16^\markup{\bold\teeny (3)} re'32 dod'32 re'16
    fad16 la16 la32 si32 dod'16 la16
