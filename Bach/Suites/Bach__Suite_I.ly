...
\score {
  <<
    \new Staff
    {
      ...
      si,16\1_\markup{\teeny III} re16-4 dod16 si,16                    % 5
      dod16-3( sol16_\markup{\teeny II}-2 la16-4)
      sol16 la16 sol16 la16 sol16
      dod16( sol16 la16) sol16 la16 sol16 la16 sol16                    % 6
      fad16-1( la16-4 re'16-2_\markup{\teeny I}) dod'16-1 re'16
      la16-4_\markup{\teeny II} sol16-2 la16
      fad16 la16 sol16 la16 re16\1_\markup{\teeny III} 
      fad16^\markup{\bold\teeny x4} mi16 re16                           % 7
      ...
      la16-4 re16( mi16 fad16) la16 sol16 fad16 mi16 re16               % 10
      sold16 re16( fa16 mi16) fa16 re16 sold!16\1 re16
      si16-4 re16(fa16\2 mi16^\markup{\bold\teeny x1})
      fa16 re16 sold!16-4 re16                                          % 11
      do16(mi16 la16) si16 do'16 la16 mi16 re16
      do16(mi16 la16) si16 do'16 la16 fad!16\4 mi16-2                   % 12
      \phrasingSlurDashed
      ...
      la16^\markup{\bold\teeny x1} sib16)-1
      sib16\3_\markup{\teeny II}( la16-2 sold16-1 la16)                 % 26
      ...
      fad16\3 la,16 re16 dod16\4 si,16 la,16-1 sol,16\open fad,16 mi,16 % 28
      ...
      si,16-1) la16\open( sol16-2 fad16 mi16\1 re16 do16 si,16          % 30
      ...
      fad16 la16 re16 la16 sol16\mf la16 mi16 la16                      % 32
      ...
      <<{\skip 16 la16[ \skip 16 la16] \skip 16 la16[ \skip 16 la16]
        ...
        {do'16[ \skip 16 si16] \skip 16 do'16[ \skip 16 la16_\1] \skip 16
         si16[ \skip 16 la16] \skip 16 si16[ \skip 16 sol16_\1] \skip 16}>> % 35
      <<{\skip 16 la16[ \skip 16 la16] \skip 16 la16[ \skip 16 la16]}\\
      ...
      sol16 re16 sold16 re16 la16 re16 sib16\2 re16                     % 37
      si!16-3 re16 do'16-4 re16 dod'16\1 re16 re'16 re16
      mib'16 re16 mi'!16\1 re16 fa'!16 re16 fad'16 re16                 % 38
      sol'16 si16( re16 si16) sol'16 si16 sol'16 si16
      sol'16 si16\( re16 si16\) sol'16 si16 sol'16 si16                 % 39
      sol'16 la16( re16 la16) sol'16 la16 sol'16 la16
      sol'16 la16\( re16 la16\) sol'16 la16 sol'16 la16                 % 40
      fad'16 do'16( re16 do'16) fad'16 do'16 fad'16 do'16
      fad'16 do'16\( re16 do'16\) fad'16 do'16 fad'16 do'16             % 41
