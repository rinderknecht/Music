...
\score {
  \new Staff {
    ...
    | si16(^\allongerUne\> sol16)
      ...
      sol,8.\!\p si16\mf do'16 si16 la16 sol16
    ...
    | sol16(^\allongerUne\> mi16) mi16(^\allongerUne si,16)
      ...
      mi,8.\!\p^\vibrato si,16 mi16 sol16\2 fad16 la16
    ...
    | fad8\mordent( \grace {\hide Stem \parenthesize sol) \undo \hide Stem}
      ...
      fad16 re16(\< fad16 sol16) la16( si16 do'!16) la16\!\mf
    ...
    | re,8. la,16\sp re16_\markup{\small\italic "ritardando"} fad16 la16 dod'16
      re'16 la16 fad16 re16 re,8.^\vibrato
    }
    ...
    | \appoggiatura {\hide Stem \parentheAll fa8 \undo \hide Stem}
      ...
      do'16^\vibrato la,16( si,16 do16) re,16^\vibrato do'16( si16 do'16)
    ...
    | \appoggiatura {\hide Stem \parenthesize la8\2 \undo \hide Stem}
      ...
      do16^\allongerUne mi16( fad16^\markup{\bold\teeny x2} sold16) la16 do'16( si16 la16)
    ...
    | sold16(\1 la16 si!16) mi16\1 fa!16 re16( do16 si,16)
      ...
      <<mi8.
        ...
        si8.\trill(>> la16)
    | <<la,8. mi8. la8.[>> \breathe si16]\3\p do'16( si16 do'16)^\allongerUne sol!16\2
      fad!16( sol16 la16)^\allongerUne mi16\1 re16 do16 si,16 la,16
    | sol,16 re16(\mf fad16 do'16) si16( la16 sol16 la16)
    ...
    | sol,16\!\p^\allongerUne re16( fad16 la16) do'16 la16 fad16 re16
