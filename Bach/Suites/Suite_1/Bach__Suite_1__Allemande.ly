...
\score {
  \new Staff {
    ...
    | \appoggiatura {\hide Stem \parentheAll fa8 \undo \hide Stem}
      mi8[\trill \appoggiatura re8(\startGroup do8)]
      do'16\stopGroup^\allongerUne la,16(\p si,16 do16) re,16^\allongerUne
      do'16(\mf\startGroup si16 do'16)
      re'16 si16 do'16 la16\stopGroup
    | \appoggiatura {\hide Stem \parenthesize la8\2 \undo \hide Stem}
      sold8\trill \appoggiatura fad8(\startGroup\3 mi8) si16\stopGroup^\allongerUne
      re16(\p do16 si,16)
    ...
    | re'8^\allongerUne si,16(\p do16) re16( mi16 fa16) la,16
      ...
      sold,8.\trill mi16-2 si16\1\mf re'16( do'16
