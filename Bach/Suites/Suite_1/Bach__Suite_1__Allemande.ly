...
\score {
  \new Staff {
    ...
    | si16(^\allongerUne\startGroup sol16)
      sol16(^\allongerUne re16) re16(^\allongerUne si,16)
      si,16(^\allongerUne sol,16)\stopGroup
      sol,8. si16 do'16^\vibrato si16 la16 sol16
    ...
    | sol16(^\allongerUne\startGroup mi16) mi16(^\allongerUne si,16)
      si,16(^\allongerUne sol,16) sol,16(^\allongerUne mi,16)\stopGroup
      mi,8.^\vibrato si,16\p mi16 sol16\2 fad16 la16
    | sol16(\4^\vibrato fad16 mi16) fad16 sol16 dod'16 sol16( fad16
      sol16) dod'16 mi16( fad16 sol16) mi16 la,16 sol16
    | fad8\mordent( \grace {\hide Stem \parenthesize sol) \undo \hide Stem}
      re16(\startGroup mi16) fad16 re16 sol16 mi16\stopGroup
      fad16^\allongerUne re16(\< fad16 sol16) la16( si16 do'!16) la16\!\mf
    | si16(^\allongerUne re16 sol,16) re16 si16 sol16 la16 fad16
      sol16^\allongerUne mi16( sol16 la16) si16( dod'16 re'16) si16
    ...
    | \appoggiatura {\hide Stem \parenthesize sol8 \undo \hide Stem}
      ...
      re'16\p la16(^\allongerUne\startGroup sol16) fad16(\3^\allongerUne
      mi16)\stopGroup
    ...
    | \appoggiatura {\hide Stem \parentheAll fa8 \undo \hide Stem}
      ...
      do'16^\allongerUne la,16(\p si,16 do16) re,16^\allongerUne do'16(\mf si16 do'16)
    ...
    | \appoggiatura {\hide Stem \parenthesize la8\2 \undo \hide Stem}
      ...
      do16^\allongerUne mi16(\mf fad16^\markup{\bold\teeny x2} sold16) la16 do'16( si16 la16)
    ...
    | sol,16 re16(_\markup{\small\italic "doux"} fad16 do'16) si16( la16 sol16 la16)
    ...
    | do'8 sol8 la,16^\allongerUne mi16( fad16 sol16)
      fad16 la16( si16 do'16)^\vibrato re16\p do16 si,16 la,16
